...
export default function AdminTable( { tableData, handleEditUser, handleDeleteUser, setOpenEditDialog, setDialogData, setOpenDeleteDialog } ) {
    return (
                    ...
                    {tableData.map(user => (
                        <Table.Row key={user.user_id}>
                            ...
                            <Table.Cell align='center'>
                                ...
                                <IconButton color='tomato' variant='soft' style={{cursor: 'pointer'}} onClick={() => {setDialogData(user); setOpenDeleteDialog(true)}}><TrashIcon width='20px' height='20px' /></IconButton>
                            </Table.Cell>
                        </Table.Row>
                    ))}
                </Table.Body>
